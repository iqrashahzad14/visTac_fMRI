...
[data_density,sizeN]=compute_density(visDir_lPC,density_distance, starting_size);
scatter(repmat(x(1,2), length(visDir_lPC), 1),data_density(:),sz,shape,'MarkerEdgeColor',darkOrange,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(visDir_rPC,density_distance, starting_size);
scatter(repmat(x(1,3), length(visDir_rPC), 1),data_density(:),sz,shape,'MarkerEdgeColor',darkOrange,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(visDir_lMTt,density_distance, starting_size);
scatter(repmat(x(1,4), length(visDir_lMTt), 1),data_density(:),sz,shape,'MarkerEdgeColor',darkOrange,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(visDir_rMTt,density_distance, starting_size);
scatter(repmat(x(1,5), length(visDir_rMTt), 1),data_density(:),sz,shape,'MarkerEdgeColor',darkOrange,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(visDir_lhMT,density_distance, starting_size);
scatter(repmat(x(1,6), length(visDir_lhMT), 1),data_density(:),sz,shape,'MarkerEdgeColor',darkOrange,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(visDir_rhMT,density_distance, starting_size);
scatter(repmat(x(1,7), length(visDir_rhMT), 1),data_density(:),sz,shape,'MarkerEdgeColor',darkOrange,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);
