function accu = calculateMvpaPropInGlasserMotor(opt)
...
%         };
    ...
    opt.maskName = {strcat('r','hemi-L_space-MNI_atlas-glasser_label-4','_mask','.nii'), ...
        strcat('r','hemi-R_space-MNI_atlas-glasser_label-4','_mask','.nii'), ...
        };
%     
%     % 'subjectExpansion'
