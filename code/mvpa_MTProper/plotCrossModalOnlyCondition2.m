...
scatter(repmat(x(1,1),length(both_rMst),1), data_density(:),sz, shape,'MarkerEdgeColor',darkPurple,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(both_rMt,density_distance, starting_size);
scatter(repmat(x(1,2),length(both_rMt),1), data_density(:),sz, shape,'MarkerEdgeColor',darkPurple,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(both_rhMT,density_distance, starting_size);
scatter(repmat(x(1,3),length(both_rhMT),1), data_density(:),sz, shape,'MarkerEdgeColor',darkPurple,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);
