...
model_series = [ mean(both_lS2); mean(both_rS2)];

model_error = [std(both_lS2)/sqrt(length(subList)); std(both_rS2)/sqrt(length(subList))];
...
% scatter(repmat(x(1,2), length(trainVis_lS2), 1),trainVis_lS2,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% scatter(repmat(x(2,2), length(trainTac_lS2), 1),trainTac_lS2,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
scatter(repmat(x(1,1), length(both_lS2), 1),both_lS2,sz,'MarkerEdgeColor',darkPurple,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);

% scatter(repmat(x(1,3), length(trainVis_rS2), 1),trainVis_rS2,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% scatter(repmat(x(2,3), length(trainTac_rS2), 1),trainTac_rS2,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
scatter(repmat(x(1,2), length(both_rS2), 1),both_rS2,sz,'MarkerEdgeColor',darkPurple,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);
