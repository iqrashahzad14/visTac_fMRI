...
%'subjectSphere'
    ...
    opt.maskPath = fullfile(fileparts(mfilename('fullpath')), '..','..', 'outputs','derivatives' ,'bidspm-roi','subjectSphere_noOverlap',strcat('sub-',subID));
    opt.maskName = {...%strcat('sub-',num2str(subID),'_hemi-L_space-MNI_label-lhMTo', '.nii'), ...
        strcat('sub-',num2str(subID),'_hemi-R_space-MNI_label-rhMTo', '.nii') ...
...
%         strcat('sub-',num2str(subID),'_hemi-R_space-MNI_label-rMTt_radiusNb-',num2str(radiusNb), '.nii'),...
    ...
    opt.maskLabel = {'rhMT'};%,'lhMT',  'lS1', 'lPC', 'rPC','lMTt', 'rMTt'};
